...
# IDC
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/idc/goodix-ts.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/goodix-ts.idc \
...
# Inherit vendor
$(call inherit-product, vendor/evercoss/EVERCOSS_U6A/EVERCOSS_U6A-vendor.mk)